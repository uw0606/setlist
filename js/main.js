    ...
    if (slotElement.dataset.itemId === 'album1-custom') {
        ...
        customNameInput.addEventListener('focus', () => {
            ...
            if (viewport) {
                ...
                console.log("[custom-song-input] Focus event: Enabled user zooming.");
            }
        });
        ...
        customNameInput.addEventListener('blur', () => {
            ...
            if (viewport) {
                // ズームを無効に戻す
                // ★以前の user-scalable=no を使う場合はこちら★
                // viewport.setAttribute('content', 'width=device-width, initial-scale=1.0, user-scalable=no');
                
                // ★タッチ操作を改善するために touch-action を使う場合はこちら★
                viewport.setAttribute('content', 'width=device-width, initial-scale=1.0');
                
                console.log("[custom-song-input] Blur event: Disabled user zooming.");
            }
        });
