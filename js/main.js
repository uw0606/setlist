...
async function generateSetlistPdf() {
    ...
    try {
        ...
        const BASE_FONT_SIZE = 100; // 行間を最大限優先
        const MAX_SONG_FONT_SIZE = 60; // ★修正ポイント1: 曲の最大フォントサイズを60ptに設定
        ...
        const SPACE_BETWEEN_HEADER_AND_BODY = 5; 
