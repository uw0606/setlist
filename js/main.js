...
async function generateSetlistPdf() {
    ...
    try {
        ...
        const topMargin = 20;
        const leftMargin = 10;
        // ★★★ 修正1: 詳細PDFのボトムマージンを10mmに設定し、描画領域を広げる ★★★
        ...
        if (numDetailedRows > 0) {
            ...
            // ボトムマージンを縮めたことで availableHeight が増え、行の高さが適切に調整される
        ...
        detailedPdf.autoTable({
            ...
            styles: {
                ...
                textColor: [0, 0, 0],
                textOverflow: 'clip',
                minCellHeight: detailedRowHeight, // 動的に計算された行の高さを適用
                valign: 'middle',
                fontStyle: 'bold' 
            },
            headStyles: {
            ...
            // ★★★ 修正2: autoTableのbottom marginも10mmに設定 ★★★
        ...
        // bottomMargin (10mm) が詳細PDFから引き継がれ、シンプルPDFにも適用される
        ...
        if (numSimpleRows > 0) {
            // シンプルPDFの行間とフォントサイズの動的調整ロジック (変更なし)
