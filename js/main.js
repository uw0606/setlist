...
async function generateSetlistPdf() {
    ...
    try {
        ...
        // --- 2. シンプルなセットリストPDFの生成 (フッター・ボトムマージン固定を適用) ---
        ...
        // ★修正1: 確定で確保したいボトムマージン (20mm) + フッターのスペース (約10mm) = 30mm
        const CALC_BOTTOM_MARGIN = 30;
        ...
        if (numSimpleRows > 0) {
            // ★修正2: 利用可能な総高さを計算する際に、CALC_BOTTOM_MARGIN (30mm) を使用
            const simpleAvailableHeight = pageHeightSimple - simpleYPos - CALC_BOTTOM_MARGIN;
        ...
        // ★ フッターの描画ロジックの追加 ★
        // ===================================
        const footerText = "Generated by Setlist Maker (C) 2024"; 
        const footerFontSize = 10; 
        const footerBottomMargin = 10; // ページ下端からのマージン(mm)
