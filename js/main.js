...
function changeAlbumView() {
    ...
    // ★★★ 修正箇所: 過去セットリストボタンと移動先/元の親要素の IDを特定 ★★★
    ...
    // アルバム順ビューでの元の親要素（仮ID: albumViewFooter）を #menuFooter に修正
    ...
    if (mode === 'name_order') {
        ...
        // ★★★ 修正の核心: 過去セットリストボタンを文字順ナビの下に移動 (変更なし) ★★★
        ...
        // ★★★ 修正の核心: 過去セットリストボタンを元の親要素に戻す ★★★
        if (pastSetlistsButton && originalParent) {
            // 元の親要素（#menuFooter）の末尾に戻す
            originalParent.appendChild(pastSetlistsButton);
