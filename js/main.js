...
const DRAG_THRESHOLD = 10; // 10ピクセル以上動いたらドラッグと判定
// const VERTICAL_SCROLL_SENSITIVITY = 2; // 不要になるので削除
...
function handleTouchMove(event) {
    ...
    if (!isDragging) {
        ...
        // DRAG_THRESHOLD に達していない場合は、何もしない（スクロールを許可）
        ...
        // ここで初めて event.preventDefault() を呼び出す
        // touch-action: none; が設定されているので、これ以降はブラウザのデフォルトスクロールは発生しない
        event.preventDefault(); 
    }
