...
function handleTouchMove(event) {
    ...
    if (!isDragging) {
        ...
        // draggingElement が handleTouchStart で正しく設定されていることを確認
        if (!draggingElement || !draggingItemId) {
            console.log("[handleTouchMove] No draggingElement or draggingItemId. Allowing scroll.");
            return;
        }
        
        // ドラッグ開始
        // draggingElement を createTouchDraggedClone に渡す
