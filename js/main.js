    ...
    if (albumItemElement && !albumItemElement.classList.contains('setlist-slot')) {
        ...
        if (firstEmptySlot) {
            ...
            addSongToSlot(firstEmptySlot, songData.itemId, songData.name, {
                ...
                // ★★★ 最終修正箇所：songDataではなく、HTML要素から直接属性を読み込む ★★★
                // これにより、getSlotItemDataが hasDrumsoloOption を取得し損ねる問題を回避します。
                drumsoloOption: albumItemElement.dataset.hasDrumsoloOption === 'true',
