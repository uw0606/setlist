    ...
    try {
        ...
        detailedPdf.autoTable({
            ...
            columnStyles: {
                ...
                1: { cellWidth: 78, halign: 'left', fontSize: 11 },     // タイトル (大きく)
                2: { cellWidth: 18, halign: 'center' },                 // R.Gt (デフォルトの8を継承)
                3: { cellWidth: 18, halign: 'center' },                 // L.Gt (デフォルトの8を継承)
                4: { cellWidth: 18, halign: 'center' },                 // Ba (デフォルトの8を継承)
        ...
        // ★★★ 修正3: 右マージンを左マージンと同じ20mmに設定 ★★★
        const simpleRightMargin = 20; 
        const simpleBottomMargin = bottomMargin; // 詳細PDFと同じ5mmを流用
        ...
        if (numSimpleRows > 0) {
            ...
            // ★★★ 修正4: 各行のフォントサイズを動的に調整するループ ★★★
            simplePdfBody.forEach(row => {
                const line = row.text;
                let currentFontSize = dynamicFontSize; // 行の初期フォントサイズは全体の動的サイズ
