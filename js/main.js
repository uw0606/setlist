// =============================================================================
// グローバル変数とDOM要素の参照 (修正後 - メニュー機能を復元)
// =============================================================================
...
// ★★★ 修正: setlist のみ一旦 null に戻します。★★★
// setlistはDOMContentLoaded内で設定する必要があります。
let setlist = null; 

// ★★★ 修正: menu, menuButton, albumList は、既存のコードがDOMContentLoaded外で
// これらの要素にアクセスしている可能性があるため、元のDOM取得に戻します。
// （ただし、これらの要素へのアクセスがDOMContentLoaded後に発生しているか確認が必要です）
// もし、これらの要素が原因で問題が発生する場合は、これらも null にし、
// DOMContentLoaded 内で設定し直す必要があります。
