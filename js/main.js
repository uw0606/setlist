...
function createTouchDraggedClone(originalElement, initialX, initialY, itemIdToClone) {
    ...
    if (setlist.contains(originalElement) && originalElement.classList.contains('setlist-item')) {
        ...
        // そして、そのスロットが一時的なプレースホルダーとして機能するようにする
        ...
        originalElement.classList.remove('setlist-item', 'short', 'se-active', 'drumsolo-active'); // 曲としてのクラスを削除
        delete originalElement.dataset.itemId; //itemIdも削除して空の状態にする
