...
function handleDragOver(event) {
    ...
    // --- ★追加/修正する自動スクロールロジックここまで★ ---

    // 以降の既存のハイライトロジックは変更なし
...
function finishDragging(wasCancelled = false) {
    ...
    if (rafId) {
        ...
        rafId = null;
        console.log("[finishDragging] Auto-scroll requestAnimationFrame stopped."); // 停止ログを追加
    }
