 ...
 * @param {Object} options - 曲のオプション。 (optionsには hasDrumsoloOption などが含まれている必要があります)
...
function addSongToSlot(slotElement, itemId, songName, options, albumClass) {
    ...
    // ★★★ 修正箇所 1: データ属性名を data-has-drumsolo-option に統一 ★★★
    // data-has-drumsolo-option が存在すれば 'true' を設定
    slotElement.dataset.hasDrumsoloOption = options.hasDrumsoloOption ? 'true' : 'false';
    ...
    // ★★★ 修正箇所 2: チェックボックスの現在の状態を示すデータ属性も data-drumsolo-checked に統一 ★★★
    ...
    // ★★★ 修正箇所 3: クラス名も drumsolo-active に統一 (元のコードが drumsolo-active だったので維持) ★★★
