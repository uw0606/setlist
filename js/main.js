...
async function generateSetlistPdf() {
    ...
    try {
        ...
        detailedPdf.autoTable({
            ...
            // ★★★ 修正2: autoTableのbottom marginも5mmに設定 ★★★
        ...
        // bottomMargin (5mm) が詳細PDFから引き継がれ、シンプルPDFにも適用される
