...
function handleTouchMove(event) {
    ...
    if (!isDragging) {
        ...
        if (deltaX > DRAG_THRESHOLD || deltaY > DRAG_THRESHOLD) {
            // ここが問題の箇所です。touchedElementのチェックを削除または修正します。
            // 代わりに、handleTouchStartで設定された draggingItemId が有効であることを確認します。
            if (!draggingItemId) {
            ...
            // ドラッグ開始
            // touchStartX, touchStartY は handleTouchStart で設定された値を使用
