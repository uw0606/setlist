...
function handleTouchStart(event) {
    ...
    if (event.touches.length === 1) {
        ...
        // ★修正点1: 長押しドラッグの可能性があればすぐにスクロールを防止
        // ただし、ダブルタップの可能性も考慮し、ダブルタップでない場合にのみpreventDefault
        // ここでは、長押し開始の可能性があれば、まずpreventDefaultを呼び出す
        // その後、timeoutでisDraggingがtrueになったら、touchmoveで継続的にpreventDefaultする
        event.preventDefault(); // スクロールを一時的に防止
        ...
        touchTimeout = setTimeout(() => {
            // timeout内で再度touchedElementが有効か確認
