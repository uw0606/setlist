...
function updateSlotContent(slotElement, songName, options) {
    ...
    if (options.hasDrumsoloOption) { 
        console.log(`[updateSlotContent] Drumsolo option is TRUE for song: ${songName}. Type: ${typeof options.hasDrumsoloOption}`);
        hasAnyCheckboxOption = true;
        ...
        console.log(`[updateSlotContent] Drumsolo option is FALSE for song: ${songName}. Type: ${typeof options.hasDrumsoloOption}`);
    }
