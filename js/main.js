...
async function generateSetlistPdf() {
    ...
    try {
        ...
        detailedPdf.autoTable({
            ...
            columnStyles: {
                0: { cellWidth: 10, halign: 'center' }, // No. (幅を少し詰めた)
                1: { cellWidth: 70, halign: 'left', fontSize: 11 }, // タイトル (幅を少し詰めた)
                2: { cellWidth: 20, halign: 'center' }, // R.Gt
                3: { cellWidth: 20, halign: 'center' }, // L.Gt
                4: { cellWidth: 20, halign: 'center' }, // Ba
                5: { cellWidth: 15, halign: 'center' }, // BPM
                6: { cellWidth: 15, halign: 'center' }, // コーラス
                7: { cellWidth: 18, halign: 'center' }  // 特効 (新しい列)
            },
