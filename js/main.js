...
function handleDragOver(event) {
    ...
    // --- ★追加: PC向け自動スクロールロジック (セットリストコンテナ内) ★ ---
    
    // SCROLL_AREA_HEIGHT, autoScrollSetlist, rafId がグローバルで定義されていることを前提
    ...
    if (targetSlot) {
        ...
        // 元のセットリストスロットからのドラッグの場合、自分自身はハイライトしない
        ...
        // ※このロジックはドラッグが終了すると解除されるため、このままで問題ありません。
