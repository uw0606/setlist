...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let wasMenuOpenBeforeModal = true; // この変数は常にtrueで良い

    // 「過去セットリスト」ボタンのイベントリスナー (変更なし)
    ...
    // 過去セットリストモーダルの閉じるボタンのイベントリスナー (変更なし)
    if (closeModalButton) {
    ...
    // 過去セットリストモーダルのオーバーレイクリックイベント (変更なし)
    ...
    // **追加**: 2025年詳細モーダルの閉じるボタンのイベントリスナー
    ...
    // **追加**: 2025年詳細モーダル内の各セットリストリンクのイベントリスナー
