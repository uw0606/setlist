...
async function generateSetlistPdf() {
    ...
    try {
        ...
        const BASE_FONT_SIZE = 100; // 曲間を最大限優先するための設定
        ...
        const SPACE_BETWEEN_HEADER_AND_BODY = 5; // ヘッダーと曲の間のマージン
        ...
        if (headerText) {
            ...
            if (headerTextWidth > availableWidth) {
                ...
                headerFontSize = Math.min(24, headerFontSize); // 24ptを最大とする
            }
        ...
        if (numSimpleRows > 0) {
            ...
            const MIN_LINE_HEIGHT_FACTOR = 0.6; // 6曲で最大の広げ幅 (40%増)
