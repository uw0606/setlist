    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "03";
                console.log(`[DOMContentLoaded] Default date set to 2026/02/03.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "KT Zepp Yokohama 1日目";
                console.log(`[DOMContentLoaded] Default venue set to KT Zepp Yokohama 1日目.`);
            }
