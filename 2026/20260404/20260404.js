    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                setlistMonth.value = "04";
                updateDays();
                setlistDay.value = "4";
                console.log(`[DOMContentLoaded] Default date set to 2026/04/4`);
            }
            if (setlistVenue) {
                setlistVenue.value = "docomo presents THE MUSIC STADIUM 2026 organized by ONE OK ROCK";
                console.log(`[DOMContentLoaded] Default venue set to docomo presents THE MUSIC STADIUM 2026 organized by ONE OK ROCK.`);
            }
