...
const album1ItemIds = [
    'album1-001', 'album1-002', 'album1-004', 'album1-005', 
    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "08";
                console.log(`[DOMContentLoaded] Default date set to 2026/03/08`);
            }
            if (setlistVenue) {
                setlistVenue.value = "Zepp Haneda (彰生誕祭)";
                console.log(`[DOMContentLoaded] Default venue set to Zepp Haneda (彰生誕祭).`);
            }

            // 初期曲として配置したいアイテムのIDリストとオプション
            const initialItems = [
                { itemId: "album1-se-custom", options: { name: "SE(TYCOON - über cozy universe)" } } ,
                ...
                { itemId: "album10-018", options: {} }, 
                { itemId: "album12-009", options: {} }, 
                { itemId: "album15-044", options: {} }, 

                { itemId: "album1-custom", options: { name: "CORE STREA - 境地マントラmix" } } ,
                ...
                // { itemId: "", options: { drumsoloChecked: true } },  // ドラムソロ有り
