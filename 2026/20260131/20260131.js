    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "31";
                console.log(`[DOMContentLoaded] Default date set to 2026/01/31`);
            }
            if (setlistVenue) {
                setlistVenue.value = "NakamuraEmi 10th Anniversary 「背負い投げ 4本目」";
                console.log(`[DOMContentLoaded] Default venue set to NakamuraEmi 10th Anniversary 「背負い投げ 4本目」`);
            }
