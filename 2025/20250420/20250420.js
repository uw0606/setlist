    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "20";
                console.log(`[DOMContentLoaded] Default date set to 2025/04/20.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "MAIZURU PLAYBACK FES.2025 2日目";
                console.log(`[DOMContentLoaded] Default venue set to MAIZURU PLAYBACK FES.2025 2日目.`);
            }

            // 初期曲として配置したいアイテムのIDリストとオプション
            const initialItems = [
                { itemId: "album1-004", options: {} }, 
