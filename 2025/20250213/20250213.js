    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "13";
                console.log(`[DOMContentLoaded] Default date set to 2025/02/13.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "滋賀県立芸術劇場 びわ湖ホール 1日目";
                console.log(`[DOMContentLoaded] Default venue set to 滋賀県立芸術劇場 びわ湖ホール 1日目.`);
            }
