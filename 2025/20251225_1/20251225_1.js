    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                setlistMonth.value = "12";
                updateDays();
                setlistDay.value = "25";
                console.log(`[DOMContentLoaded] Default date set to 2025/12/25.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "日本武道館~PREMIUM LIVE on Xmas 2025~ 昼公演";
                console.log(`[DOMContentLoaded] Default venue set to 日本武道館~PREMIUM LIVE on Xmas 2025~ 昼公演.`);
            }

            // 初期曲として配置したいアイテムのIDリストとオプション
            const initialItems = [
                { itemId: "album1-custom", options: { name: "SE(Last Christmas〜TYCOON)" } }, 

                { itemId: "album14-003", options: {} }, 
                { itemId: "album2-001", options: {} }, 
                { itemId: "album5-005", options: { short: true } }, 
                { itemId: "album11-006", options: {} }, 
                { itemId: "album14-008", options: {} }, 
                { itemId: "album9-009", options: {} }, 

                { itemId: "album1-002", options: {} }, 

                { itemId: "album15-027", options: { short: true } }, 
                { itemId: "album10-007", options: { short: true } }, 
                { itemId: "album10-015", options: {} }, 
                { itemId: "album10-012", options: { short: true } }, 
                { itemId: "album4-011", options: { short: true } }, 
                { itemId: "album2-009", options: {} }, 
                { itemId: "album15-044", options: {} }, 
                { itemId: "album11-011", options: {} }, 
