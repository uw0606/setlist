    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "07";
                console.log(`[DOMContentLoaded] Default date set to 2025/12/07.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "Aichi Sky Expo ホールA 2日目";
                console.log(`[DOMContentLoaded] Default venue set to Aichi Sky Expo ホールA 2日目.`);
            }
