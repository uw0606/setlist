    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "05";
                console.log(`[DOMContentLoaded] Default date set to 2025/04/05.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "SUPER BEAVER 自主企画 『現場至上主義 2025』";
                console.log(`[DOMContentLoaded] Default venue set to SUPER BEAVER 自主企画 『現場至上主義 2025』.`);
            }
            ...
            const initialItems = [
                ...
                { itemId: "album1-custom", options: { name: "ENCORE AGAIN (feat. SHUNTO from BE:FIRST)" } }, 
