    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "21";
                console.log(`[DOMContentLoaded] Default date set to 2025/07/21.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "NUMBER SHOT 2025";
                console.log(`[DOMContentLoaded] Default venue set to NUMBER SHOT 2025.`);
            }

            // 初期曲として配置したいアイテムのIDリストとオプション
            const initialItems = [
                { itemId: "album1-001", options: {} }, 
