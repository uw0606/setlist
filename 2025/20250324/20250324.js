    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "24";
                console.log(`[DOMContentLoaded] Default date set to 2025/03/24.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "HIROSHIMA CLUB QUATTRO 1日目";
                console.log(`[DOMContentLoaded] Default venue set to HIROSHIMA CLUB QUATTRO 1日目.`);
            }
