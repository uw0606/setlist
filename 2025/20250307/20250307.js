    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "07";
                console.log(`[DOMContentLoaded] Default date set to 2025/03/07.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "Zepp Fukuoka 1日目";
                console.log(`[DOMContentLoaded] Default venue set to Zepp Fukuoka 1日目.`);
            }

            // 初期曲として配置したいアイテムのIDリストとオプション
            const initialItems = [
                { itemId: "album1-011", options: {} }, 

                { itemId: "album9-006", options: {} }, 
                { itemId: "album7-002", options: {} },
                { itemId: "album5-007", options: {} }, 
                { itemId: "album13-006", options: {} }, 
                { itemId: "album11-014", options: {} }, 
