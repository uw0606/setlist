    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "21";
                console.log(`[DOMContentLoaded] Default date set to 2025/02/21.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "Zepp Haneda 1日目";
                console.log(`[DOMContentLoaded] Default venue set to Zepp Haneda 1日目.`);
            }
            ...
            const initialItems = [
                ...
                { itemId: "album8-010", options: { short: true } }, 
                { itemId: "album9-003", options: {} }, 
                { itemId: "album3-001", options: {} }, 
