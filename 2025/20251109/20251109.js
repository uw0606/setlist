    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "09";
                console.log(`[DOMContentLoaded] Default date set to 2025/11/09.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "LUNATIC FEST. 2025";
                console.log(`[DOMContentLoaded] Default venue set to LUNATIC FEST. 2025.`);
            }
            ...
            const initialItems = [
                ...
                { itemId: "album1-custom", options: { name: "ROSIER feat.RYUICHI（LUNA SEA）" } }, 
