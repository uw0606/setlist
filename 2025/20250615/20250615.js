...
document.addEventListener('DOMContentLoaded', () => {
    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistVenue) {
                setlistVenue.value = "TOKYO DOME 2日目";
                console.log(`[DOMContentLoaded] Default venue set to TOKYO DOME 2日目.`);
            }
            ...
            const initialItems = [
                ...
                { itemId: "album8-002", options: { short: true } },
                { itemId: "album10-013", options: { short: true } }, 
                ...
                { itemId: "album4-005", options: { short: true } }, 
                { itemId: "album10-010", options: { short: true } }, 
                { itemId: "album2-001", options: { short: true } }, 
                { itemId: "album7-005", options: { short: true } }, 
                { itemId: "album3-009", options: { short: true } }, 
                { itemId: "album15-028", options: { short: true } }, 
                { itemId: "album4-009", options: { short: true } }, 
                { itemId: "album10-016", options: { short: true } }, 
                { itemId: "album13-001", options: {} }, 

                { itemId: "album1-021", options: {} }, 
