    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                setlistMonth.value = "11";
                updateDays();
                setlistDay.value = "29";
                console.log(`[DOMContentLoaded] Default date set to 2025/11/29.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "朱鷺メッセ 1日目";
                console.log(`[DOMContentLoaded] Default venue set to 朱鷺メッセ 1日目.`);
            }
