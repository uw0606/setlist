    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "26";
                console.log(`[DOMContentLoaded] Default date set to 2025/11/26.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "長野CLUB JUNK BOX";
                console.log(`[DOMContentLoaded] Default venue set to 長野CLUB JUNK BOX.`);
            }
