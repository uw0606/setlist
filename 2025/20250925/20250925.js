    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                setlistMonth.value = "09";
                updateDays();
                setlistDay.value = "25";
                console.log(`[DOMContentLoaded] Default date set to 2025/09/25.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "Zepp Sapporo 2日目 (誠果生誕祭)";
                console.log(`[DOMContentLoaded] Default venue set to Zepp Sapporo 2日目 (誠果生誕祭).`);
            }
            ...
            const initialItems = [
                ...
                { itemId: "album1-005", options: {name: "Touch off（Fes.SE ver）" } }, 
                { itemId: "album10-007", options: {} },
                { itemId: "album8-010", options: {} }, 
                { itemId: "album14-003", options: {} }, 
                { itemId: "album3-005", options: {} }, 
                { itemId: "album9-014", options: {} }, 

                { itemId: "album1-002", options: {} }, 

                { itemId: "album7-004", options: { short: true, seChecked: true } }, 
                { itemId: "album10-002", options: {} }, 
                { itemId: "album4-003", options: { short: true } }, 
                { itemId: "album5-006", options: {} }, 
                { itemId: "album5-013", options: {} }, 
                { itemId: "album15-011", options: {} }, 

                { itemId: "album1-018", options: {} }, 
