    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "06";
                console.log(`[DOMContentLoaded] Default date set to 2025/12/06.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "Aichi Sky Expo ホールA 1日目";
                console.log(`[DOMContentLoaded] Default venue set to Aichi Sky Expo ホールA 1日目.`);
            }
            ...
            const initialItems = [
                ...
                { itemId: "album13-005", options: { seChecked: true } }, 
                { itemId: "album14-007", options: {} }, 
