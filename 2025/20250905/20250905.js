    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "05";
                console.log(`[DOMContentLoaded] Default date set to 2025/09/05.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "柏PALOOZA（千葉）";
                console.log(`[DOMContentLoaded] Default venue set to 柏PALOOZA（千葉）.`);
            }
