    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                setlistMonth.value = "08";
                updateDays();
                setlistDay.value = "24";
                console.log(`[DOMContentLoaded] Default date set to 2025/08/24.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "MONSTER baSH 2025";
                console.log(`[DOMContentLoaded] Default venue set to MONSTER baSH 2025.`);
            }
