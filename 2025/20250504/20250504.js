    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "04";
                console.log(`[DOMContentLoaded] Default date set to 2025/05/04.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "VIVA LA ROCK 2025";
                console.log(`[DOMContentLoaded] Default venue set to VIVA LA ROCK 2025.`);
            }

            // 初期曲として配置したいアイテムのIDリストとオプション
            const initialItems = [
                { itemId: "album1-custom", options: { name: "ドラムソロ" } }, 
