    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                setlistMonth.value = "06";
                updateDays();
                setlistDay.value = "14";
                console.log(`[DOMContentLoaded] Default date set to 2025/07/06.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "TOKYO DOME 1日目";
                console.log(`[DOMContentLoaded] Default venue set to TOKYO DOME 1日目.`);
            }
            ...
            const initialItems = [
                ...
                { itemId: "album9-004", options: { short: true } },
                { itemId: "album10-007", options: { short: true } }, 
                { itemId: "album8-005", options: { short: true } }, 
                { itemId: "album15-027", options: { short: true } }, 
                { itemId: "album14-003", options: {} }, 
                { itemId: "album14-010", options: {} }, 

                { itemId: "album1-002", options: {} }, 

                { itemId: "album11-003", options: { seChecked: true } }, 
                { itemId: "album5-005", options: { short: true } }, 
                { itemId: "album2-001", options: { short: true } }, 
                { itemId: "album11-007", options: { short: true } }, 
                { itemId: "album10-002", options: { short: true } }, 
                { itemId: "album15-030", options: {} }, 
                { itemId: "album8-006", options: { short: true } }, 
                { itemId: "album9-015", options: {} }, 
                { itemId: "album6-008", options: { short: true } }, 
                { itemId: "album11-002", options: {} }, 

                { itemId: "album14-012", options: {} }, 
                
                { itemId: "album14-006", options: {} }, 
                { itemId: "album10-008", options: {} }, 
                { itemId: "album14-004", options: {} }, 
                { itemId: "album9-001", options: {} }, 
                { itemId: "album9-002", options: {} }, 
                { itemId: "album14-005", options: {} }, 
                { itemId: "album12-001", options: {} }, 
                { itemId: "album9-0102", options: {} }, 
