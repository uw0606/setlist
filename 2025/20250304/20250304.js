    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "04";
                console.log(`[DOMContentLoaded] Default date set to 2025/03/04.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "NAGANO CLUB JUNK BOX 2日目";
                console.log(`[DOMContentLoaded] Default venue set to NAGANO CLUB JUNK BOX 2日目.`);
            }

            // 初期曲として配置したいアイテムのIDリストとオプション
            const initialItems = [
                { itemId: "album1-008", options: { drumsoloChecked: true } }, 

                { itemId: "album9-006", options: {} }, 
                { itemId: "album15-026", options: { short: true } },
                { itemId: "album2-003", options: {} }, 
                { itemId: "album4-010", options: { short: true } }, 
                { itemId: "album15-016", options: {} }, 

                { itemId: "album1-002", options: {} }, 

                { itemId: "album6-003", options: {} }, 
                { itemId: "album15-032", options: {} }, 
                { itemId: "album6-010", options: { short: true } }, 
                { itemId: "album15-022", options: {} }, 
                { itemId: "album8-009", options: {} }, 
                { itemId: "album15-019", options: { short: true } }, 
                { itemId: "album15-038", options: {} }, 
                { itemId: "album13-001", options: {} }, 
                { itemId: "album15-012", options: {} }, 
