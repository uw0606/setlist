    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "25";
                console.log(`[DOMContentLoaded] Default date set to 2025/03/25.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "HIROSHIMA CLUB QUATTRO 2日目";
                console.log(`[DOMContentLoaded] Default venue set to HIROSHIMA CLUB QUATTRO 2日目.`);
            }
