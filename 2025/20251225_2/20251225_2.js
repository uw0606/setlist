...
document.addEventListener('DOMContentLoaded', () => {
    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistVenue) {
                setlistVenue.value = "日本武道館~PREMIUM LIVE on Xmas 2025~ 夜公演";
                console.log(`[DOMContentLoaded] Default venue set to 日本武道館~PREMIUM LIVE on Xmas 2025~ 夜公演.`);
            }
            ...
            const initialItems = [
                ...
                { itemId: "album9-005", options: { short: true } }, 
                { itemId: "album14-003", options: {} }, 
                { itemId: "album3-010", options: {} }, 
                { itemId: "album14-008", options: {} }, 
                { itemId: "album9-009", options: {} }, 
                { itemId: "album8-007", options: {} }, 
