    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "07";
                console.log(`[DOMContentLoaded] Default date set to 2025/09/07.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "WANIMA pre. 1CHANCE FESTIVAL 2025";
                console.log(`[DOMContentLoaded] Default venue set to WANIMA pre. 1CHANCE FESTIVAL 2025.`);
            }
