    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "05";
                console.log(`[DOMContentLoaded] Default date set to 2025/02/05.`);
            }
            if (setlistVenue) {
            ...
            const initialItems = [
                { itemId: "album1-007", options: {} }, 

                { itemId: "album15-042", options: {} }, 
                { itemId: "album11-004", options: {} },
                { itemId: "album15-027", options: {} }, 
                { itemId: "album15-005", options: {} }, 
                { itemId: "album13-005", options: {} }, 
                { itemId: "album10-010", options: {} }, 

                { itemId: "album1-002", options: {} }, 

                { itemId: "album10-007", options: {} }, 
                { itemId: "album8-009", options: {} }, 
                { itemId: "album4-011", options: {} }, 
                { itemId: "album13-001", options: {} }, 
                { itemId: "album12-012", options: {} }, 
                { itemId: "album10-004", options: {} }, 
                { itemId: "album7-012", options: {} }, 
                ...
                { itemId: "album3-011", options: {} }, 
                { itemId: "album9-012", options: {} }, 
