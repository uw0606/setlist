    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "14";
                console.log(`[DOMContentLoaded] Default date set to 2025/02/14.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "滋賀県立芸術劇場 びわ湖ホール 2日目 (信人生誕祭)";
                console.log(`[DOMContentLoaded] Default venue set to 滋賀県立芸術劇場 びわ湖ホール 2日目 (信人生誕祭).`);
            }
