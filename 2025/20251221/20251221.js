    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "21";
                console.log(`[DOMContentLoaded] Default date set to 2025/12/21.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "横浜アリーナ 2日目 (TAKUYA∞生誕祭)";
                console.log(`[DOMContentLoaded] Default venue set to 横浜アリーナ 2日目 (TAKUYA∞生誕祭).`);
            }
