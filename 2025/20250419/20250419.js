    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "19";
                console.log(`[DOMContentLoaded] Default date set to 2025/04/19.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "MAIZURU PLAYBACK FES.2025 1日目";
                console.log(`[DOMContentLoaded] Default venue set to MAIZURU PLAYBACK FES.2025 1日目.`);
            }
