    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "11";
                console.log(`[DOMContentLoaded] Default date set to 2025/05/11.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "METROCK 2025";
                console.log(`[DOMContentLoaded] Default venue set to METROCK 2025.`);
            }
