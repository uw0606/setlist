    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "13";
                console.log(`[DOMContentLoaded] Default date set to 2025/12/13.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "広島グリーンアリーナ 1日目";
                console.log(`[DOMContentLoaded] Default venue set to 広島グリーンアリーナ 1日目.`);
            }
