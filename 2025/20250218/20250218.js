    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "18";
                console.log(`[DOMContentLoaded] Default date set to 2025/02/18.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "Zepp Osaka Bayside 2日目";
                console.log(`[DOMContentLoaded] Default venue set to Zepp Osaka Bayside 2日目.`);
            }

            // 初期曲として配置したいアイテムのIDリストとオプション
            const initialItems = [
                { itemId: "album1-010", options: {} }, 

                { itemId: "album14-006", options: {} }, 
                { itemId: "album12-011", options: {} },
                { itemId: "album15-016", options: {} }, 
                { itemId: "album11-013", options: {} }, 
                { itemId: "album4-003", options: {} }, 
                { itemId: "album7-003", options: {} }, 

                { itemId: "album1-002", options: {} }, 

                { itemId: "album15-030", options: {} }, 
                { itemId: "album10-005", options: {} }, 
                { itemId: "album9-013", options: {} }, 
                { itemId: "album12-006", options: {} }, 
                { itemId: "album5-014", options: { short: true } }, 
                { itemId: "album5-006", options: {} }, 
                { itemId: "album15-014", options: {} }, 
                ...
                { itemId: "album6-011", options: {} }, 
                { itemId: "album11-003", options: {} }, 
                { itemId: "album3-009", options: {} }, 
