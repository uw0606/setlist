    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "19";
                console.log(`[DOMContentLoaded] Default date set to 2025/09/10.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "コーチャンフォー釧路文化ホール 大ホール";
                console.log(`[DOMContentLoaded] Default venue set to コーチャンフォー釧路文化ホール 大ホール.`);
            }
