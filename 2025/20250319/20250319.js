    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "19";
                console.log(`[DOMContentLoaded] Default date set to 2025/03/19.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "Zepp Sapporo 2日目";
                console.log(`[DOMContentLoaded] Default venue set to Zepp Sapporo 2日目.`);
            }
