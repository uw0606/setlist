    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "03";
                console.log(`[DOMContentLoaded] Default date set to 2025/03/03.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "NAGANO CLUB JUNK BOX 1日目";
                console.log(`[DOMContentLoaded] Default venue set to NAGANO CLUB JUNK BOX 1日目.`);
            }
