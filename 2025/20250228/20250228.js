    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "28";
                console.log(`[DOMContentLoaded] Default date set to 2025/02/28.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "SENDAI GIGS 2日目";
                console.log(`[DOMContentLoaded] Default venue set to SENDAI GIGS 2日目.`);
            }
            ...
            const initialItems = [
                ...
                { itemId: "album10-013", options: {} }, 
                { itemId: "album15-021", options: {} }, 
