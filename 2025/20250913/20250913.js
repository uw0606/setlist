    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "13";
                console.log(`[DOMContentLoaded] Default date set to 2025/09/13.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "ROCK IN JAPAN FESTIVAL 2025";
                console.log(`[DOMContentLoaded] Default venue set to ROCK IN JAPAN FESTIVAL 2025.`);
            }
