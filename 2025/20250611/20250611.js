    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "11";
                console.log(`[DOMContentLoaded] Default date set to 2025/06/11.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "Shibuya eggman";
                console.log(`[DOMContentLoaded] Default venue set to Shibuya eggman.`);
            }
            ...
            const initialItems = [
                ...
                { itemId: "album10-012", options: {} }, 
                { itemId: "album2-007", options: {} }, 
                { itemId: "album4-007", options: {} }, 
                { itemId: "album6-004", options: {} }, 
