    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "27";
                console.log(`[DOMContentLoaded] Default date set to 2025/02/27.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "SENDAI GIGS 1日目";
                console.log(`[DOMContentLoaded] Default venue set to SENDAI GIGS 1日目.`);
            }
