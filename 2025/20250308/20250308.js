    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "08";
                console.log(`[DOMContentLoaded] Default date set to 2025/03/12.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "Zepp Fukuoka 2日目 (彰生誕祭)";
                console.log(`[DOMContentLoaded] Default venue set to Zepp Fukuoka 2日目 (彰生誕祭).`);
            }

            // 初期曲として配置したいアイテムのIDリストとオプション
            const initialItems = [
                { itemId: "album1-014", options: {} }, 

                { itemId: "album5-014", options: { short: true } }, 
                { itemId: "album14-006", options: {} },
                { itemId: "album2-007", options: { short: true } }, 
                { itemId: "album4-007", options: { short: true } }, 
                ...
                { itemId: "album5-010", options: {} }, 
                { itemId: "album15-015", options: {} }, 

                { itemId: "album1-016", options: {} }, 
