    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "05";
                console.log(`[DOMContentLoaded] Default date set to 2025/11/05.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "SENDAI GIGS 2日目 (真太郎生誕祭)";
                console.log(`[DOMContentLoaded] Default venue set to SENDAI GIGS 2日目 (真太郎生誕祭).`);
            }
