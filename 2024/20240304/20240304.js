    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "04";
                console.log(`[DOMContentLoaded] Default date set to 2024/03/04.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "Zepp Osaka Bayside";
                console.log(`[DOMContentLoaded] Default venue set to Zepp Osaka Bayside.`);
            }
