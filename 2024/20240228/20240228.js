    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "28";
                console.log(`[DOMContentLoaded] Default date set to 2024/02/28.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "Zepp Nagoya";
                console.log(`[DOMContentLoaded] Default venue set to Zepp Nagoya.`);
            }
