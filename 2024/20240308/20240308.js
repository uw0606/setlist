    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "08";
                console.log(`[DOMContentLoaded] Default date set to 2024/03/08.`);
            }
            if (setlistVenue) {
            ...
            const initialItems = [
                ...
                { itemId: "album6-003", options: { seChecked: true } }, 
                ...
                { itemId: "album1-custom", options: { name: "SOUL / Guest : 愛笑む (徳川eq.) + 青山テルマ" } } ,
