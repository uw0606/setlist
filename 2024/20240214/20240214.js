    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "14";
                console.log(`[DOMContentLoaded] Default date set to 2024/02/14.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "弘前市民会館 (信人生誕祭)";
                console.log(`[DOMContentLoaded] Default venue set to 弘前市民会館 (信人生誕祭).`);
            }
