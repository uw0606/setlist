    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "02";
                console.log(`[DOMContentLoaded] Default date set to 2024/03/02.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "OSAKA MUSE";
                console.log(`[DOMContentLoaded] Default venue set to OSAKA MUSE.`);
            }
