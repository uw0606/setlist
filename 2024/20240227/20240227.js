    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "27";
                console.log(`[DOMContentLoaded] Default date set to 2024/02/27.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "THE BOTTOM LINE (名古屋)";
                console.log(`[DOMContentLoaded] Default venue set to THE BOTTOM LINE (名古屋).`);
            }
            ...
            const initialItems = [
                ...
                { itemId: "album2-009", options: { seChecked: true } }, 
