    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                setlistDay.value = "21";
                console.log(`[DOMContentLoaded] Default date set to 2024/02/21.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "福岡DRUM LOGOS";
                console.log(`[DOMContentLoaded] Default venue set to 福岡DRUM LOGOS.`);
            }
