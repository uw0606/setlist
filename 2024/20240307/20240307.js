    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "07";
                console.log(`[DOMContentLoaded] Default date set to 2024/03/07.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "恵比寿LIQUIDROOM";
                console.log(`[DOMContentLoaded] Default venue set to 恵比寿LIQUIDROOM.`);
            }
            ...
            const initialItems = [
                ...
                { itemId: "album11-014", options: { short: true } }, 
                { itemId: "album15-022", options: { short: true } }, 
                { itemId: "album2-002", options: {} }, 
                { itemId: "album4-010", options: { short: true } }, 
                { itemId: "album3-006", options: {} }, 
                { itemId: "album11-009", options: {} }, 

                { itemId: "album1-002", options: {} }, 

                { itemId: "album8-008", options: {} }, 
                { itemId: "album6-002", options: {} },  
                { itemId: "album5-004", options: {} }, 
                { itemId: "album4-006", options: { short: true } }, 
                { itemId: "album15-003", options: {} },  
                { itemId: "album9-008", options: {} }, 
