...
document.addEventListener('DOMContentLoaded', () => {
    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            preloadedSongs.forEach((songData, index) => {
                ...
                if (slot && !slot.classList.contains('setlist-item')) {
                    ...
                    // originalAlbumMap.set(songData.itemId, songData.albumClass); // fillSlotWithItem内で設定されるため不要
                    console.log(`[DOMContentLoaded] Preloaded item ${songData.name} into slot ${index}.`);
                }
            });
        }
