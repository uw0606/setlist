    ...
    loadSetlistState().then(() => {
        ...
        if (!hasShareOrPastId) {
            ...
            if (setlistYear && setlistMonth && setlistDay) {
                ...
                updateDays();
                setlistDay.value = "19";
                console.log(`[DOMContentLoaded] Default date set to 2025/07/19.`);
            }
            if (setlistVenue) {
                setlistVenue.value = "JOIN ALIVE 2025";
                console.log(`[DOMContentLoaded] Default venue set to JOIN ALIVE 2025.`);
            }
